...
<head>
    ...
    <title>Lido Vetrana - Area Admin</title>
                ...
                <div id="sidebar-wrapper" style="background-color: rgb(255,255,255);">
                    <ul class="sidebar-nav">
                        <li class="sidebar-brand">
                        	<a href="/guidafederico/view/home">Home </a>
                        </li>
                        <li> 
                        	<a id="personal" type="button">Area dipendenti<i class="fas fa-user"></i></a>
                        	<a id="lido" type="button">Area lido<i class="fas fa-umbrella-beach"></i></a>
                        </li>
                        <li> 
                        	<a id="restaurant" type="button">Area ristorante<i class="fa fa-shopping-basket"></i></a>
                        </li>
                        <li> 
